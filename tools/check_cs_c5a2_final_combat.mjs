...
check("route planner shares collision radius and normalizes only waypoints", includesAll(fps, ["const margin=R+0.08", "cornerVertices.filter", "map(p=>snapOut", "safeMove(p.pos,des,walls,PLAYER_R)"]));
