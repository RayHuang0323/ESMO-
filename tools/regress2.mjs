...
const GATES = {
  ...
  //    等級：v1 恆為 1.00（沒有本場 XP）；Milestone C-fix 刻意把 v3 首波從
  //      4×128=512 降為 4×96=384，避免 Lv1→Lv3 同波暴衝。20 seeds 新基準
  //      平均 3.18、最低 2.6，因此門檻改為逐場 ≥2.5 / 平均 [3.0, 7.0]：
  //      仍能直接攔下「沒有 XP」與異常封頂，且不把已確認過快的舊曲線當成功。
  lv5Min: 2.5, lv5MeanLo: 3.0, lv5MeanHi: 7.0,
};
