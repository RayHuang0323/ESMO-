...
async function main() {
  ...
  `expected=${CAPTURED_ENGINE_SOURCE_SHA256}, ${R10_ENGINE_SOURCE_SHA256}, ${CS_R11_REPAIRED_SOURCE_SHA256}, ${CS_R13_PLAYER_SMOKE_SOURCE_SHA256}, ${CS_R19_SEMANTIC_SOURCE_SHA256}\nactual=${sourceSha256}`);
