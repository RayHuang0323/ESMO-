...
const SEGMENTS = [
  ...
  { id: "cs_match_completion", script: "tools/check_cs_match_completion.mjs", shape: /CS MR12 completion: 31\/31 PASS/, note: "CS MR12／halftime／OT／final-frame completion regression" },
